  ...
  return (
    <Card className="h-full flex flex-col hover:shadow-xl transition-all duration-300 border-primary-200 hover:border-accent-300 bg-white hover:bg-primary-50 group">
      <CardContent className="flex flex-col h-full ">
        ...
        <div className="aspect-square bg-gradient-to-br from-primary-100 to-accent-100 rounded-xl mb-6 flex items-center justify-center group-hover:from-accent-100 group-hover:to-primary-200 transition-all duration-300">
